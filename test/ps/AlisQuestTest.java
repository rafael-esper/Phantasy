...
public class AlisQuestTest {
	...
	public void testRoadpass() {
		...
		VergeEngine.systemclass = Scion.class; // hack to deal with not loading maps on simulation
		Scion.hand_shop();
	...
	public void testBayaMalay() {
		...
		BattleTest.advanceToLevel(PSGame.getParty().getMember(0), 90);
		BattleTest.advanceToLevel(PSGame.getParty().getMember(1), 90);
		BattleTest.advanceToLevel(PSGame.getParty().getMember(2), 90);
		BattleTest.advanceToLevel(PSGame.getParty().getMember(3), 90);
